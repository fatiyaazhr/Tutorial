        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            //Membuat objek FileOutputStream untuk proses penyimpanan output file
                FileOutputStream fos = new FileOutputStream(myExternalFile);
                  // Menuliskan isi file berdasarkan inputan use
...
// Melakukan pengecekan text file kosong atau tidak
                ...
                e.printStackTrace();
            }  inputText.setText(myData);  response.setText("SampleFile.txt data retrieved from Internal Storage...");
            }
        });
...
// Jika tidak maka tombol simpan akan disable
    ...
    if (Environment.MEDIA_MOUNTED_READ_ONLY.equals(extStorageState)) {             return true;
    }
